		...
		<div class="row ipad-width">
			...
			<div class="col-md-4">
				<div class="sidebar">
					...
					<div class="container">
<p style="text-align:center"><a class="bb" href="{{url('add')}}">Add Data</a><p>

    <div style="display: flex;flex-direction: row;flex-wrap: nowrap;paddind:5%;">
    ...
    <div class="card" style="width:25rem">
       <iframe  src="{{$data->Movie}}" title="YouTube video player" frameborder="0" allow="accelerometer; autoplay; clipboard-write; encrypted-media; gyroscope; picture-in-picture"   allowfullscreen></iframe> 
        ...
        <div class="card-body">
          <a class="bb" href="{{url('edit/id/'.$data->id)}}">Update</a> 
          <a class="bb" href="{{url('delete-data/id/'.$data->id)}}" style="margin:10px auto;">Delete</a> 
        </div>
      </div>
      @endforeach
